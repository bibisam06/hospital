...
void main()
{
    ...
    _putenv("NLS_LANG=American_America.KO16KSC5601");  //??ùù??ùù?

   /* Register sql_error() as the error handler. */
    /* EXEC SQL WHENEVER SQLERROR DO sql_error("\7ùùùù??"); */ 
...

{
   ...
   // EXEC SQL WHENEVER NOT FOUND DO break ;  ùùùùùù ?ùù????µù ùùùù ùùùùùù ?ùù?ùùùù ùùùù?
   while(1)
    {
        /* 3. tuple fetch */
...

{
        ...
        if(sqlca.sqlcode == 1403) {  // ùù??ùùùùùù ùùùùùù ùùùù ùù?
            break;
        }
...
/*------  ùùùùùù ùùùùùù ùùùù ???ùùùù?ùù?ùùùùùù ----------------*/
...

{
    ...
    /*  ùùùùùù ùùùùùù ?ùù?ùùùù ùùùù ?ùù?ùù?ùù ùù?ùù?ùù */
    if ( sqlca.sqlerrd[2] == 0 ) {
        printf("?ùù?ùùùùùù ùùùù??!!  ??ùù ?ùùùù");
        getch();
        return ;
    }
...

{
    ...
    // ùùùù ????
    printf("ùùùù ùùùıùù?ùùùù??ùù?? (y/n) :");   
...

{
        ...
        if( Error_flag == 0 ) {  // ùùùùùùùùùù ùùùù ??ùù?
            printf("\n");	
            printf(" ùùùùùùùùùù ùùùù?ùùùù??  ??ùù ?ùùùù \n" ) ;
            /* EXEC SQL COMMIT WORK ; */ 

{
        ...
        else {   //Error_falg == 1. ùùùùùù ?ùù?ùù?
            printf("\n");	
            printf(" ?ùùùù ùùùùùùùù ??ùù?? ??ùù ?ùùùù \n" ) ;
            /* EXEC SQL ROLLBACK WORK ; */ 
...
void sql_error(char *msg)
{
    ...
    getxy(&x, &y);  // ùùùù ?ùù ùù? ùùùù

    Error_flag = 1;    //ùùùùùù ?ùùùù?ùùùùùù
    ...
    gotoxy(x, y) ;   // ùùùùùù ?ùù?ùùùù ?ùù ùù?ùù ??
    //getch();
}
/*---------------  ?ùù ?ùù ùùùù ??--------------------*/
